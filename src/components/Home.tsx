...
export function Home() {
  ...
  return <div className="h-full w-full bg-gray-50 overflow-auto">
      <div className="max-w-2xl mx-auto p-4">
        ...
        <div className="bg-white rounded-xl p-4 shadow-sm mb-4">
          ...
          <div className="flex justify-between items-center">
            <div>
              <p className="text-gray-600">Cards due</p>
        ...
        <div className="grid grid-cols-2 gap-4 mb-8">
          <div className="bg-white rounded-xl p-4 shadow-sm">
            ...
            <h3 className="font-semibold mb-1">Streak</h3>
        ...
        <div className="border-t border-gray-200 pt-6">
          <h2 className="text-xl font-bold mb-2">Arabic Course</h2>
          <p className="text-gray-600 mb-6">
            Select a lesson to start learning
          </p>
          <div className="space-y-3">
            {lessons.map(lesson => <button key={lesson.id} onClick={() => navigate(`/lesson/${lesson.id}`)} className={`w-full p-4 rounded-xl border ${colorVariants[lesson.color]} text-left transition-all duration-200 hover:shadow-md`}>
